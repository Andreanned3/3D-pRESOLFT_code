    ...
    def __init__(self, *args, **kwargs):
        ...
        params = [
            ...
            {'name': 'Pattern', 'type': 'group', 'children': [
                ...
                {'name': 'Row-period', 'type': 'float', 'value': 11.75, 'limits': (0, 9999)},
                {'name': 'Col-period', 'type': 'float', 'value': 11.75, 'limits': (0, 9999)},
...
class Data_Frame(QtGui.QFrame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.pattern = []
        self.pattern_grid = []
        self.data_edit = DataEdit(self.parent)
    ...
    def unloadData(self):
        ...
        self.slider.setMaximum(0)
        self.parent.delete_current_data()
